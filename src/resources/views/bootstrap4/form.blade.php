                            ...
                            <div class="articles available-articles well">
                                @foreach ($articles as $article)
                                    <div id="article-available-{{ $article->id }}"
                                        class="article btn btn-light btn-block"
                            ...
                            <div class="articles selected-articles well">
                                @if (!empty($email->articles))
                                    @foreach ($email->articles as $id)
                                        <?php
                                        $articleClass = \Jzpeepz\Enews\Enews::getPublishArticleClass();
                                        $a = $articleClass::find(array('id' => $id));
                                        ?>
                                        <div id="article-selected-{{ $id }}>" class="article btn btn-light btn-block" data-article-id="{{ $id }}">
