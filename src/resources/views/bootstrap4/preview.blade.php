        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('jzpeepz.enews.send', $email->id) }}" method="post" role="form">
                    ...
                    <a href="{{ route('jzpeepz.enews.edit', $email->id) }}" class="btn btn-light">Edit</a>
                    @if (! empty($email->campaign_id))
                    <a href="https://app.adestra.com/Abpg/campaign/{{ $email->campaign_id }}/view" class="btn btn-light" target="_blank">View in Adestra</a>
                    @endif
                </form>
